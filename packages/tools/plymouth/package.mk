...
PKG_NAME="plymouth"
PKG_VERSION="b9f2aac5"
PKG_REV="1"
PKG_ARCH="any"
PKG_LICENSE="GPL"
PKG_SITE="https://cgit.freedesktop.org/plymouth/"
PKG_URL="https://gitlab.freedesktop.org/plymouth/plymouth/-/archive/master/plymouth-$PKG_VERSION.tar.gz"
PKG_DEPENDS_INIT="toolchain gcc:init libdrm:init zlib:init libpng"
PKG_DEPENDS_TARGET="toolchain libdrm zlib libpng"
PKG_SECTION="tools"
...
post_makeinstall_init() {
  ...
  mkdir -p $INSTALL/usr/share/plymouth
    ...
    cp $DISTRO_DIR/$DISTRO/le-header-logo.png $INSTALL/usr/share/plymouth/themes/spinner/header-image.png
